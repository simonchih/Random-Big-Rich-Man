...
(For linux won't support openjdk, only support oracle java)

For linux, to play using java -jar <file_name>
e.g.
java -jar Random_Big_Rich_Man.jar
...
Q&A.
Q:在Windows 10所顯示的字型很醜，跟網站上的圖片不符，是怎麼回事？
A:查看 設定 -> 系統 -> 顯示器 -> 變更文字、應用程式與其它項目的大小
看是否不是 100% (通常是125%), 請改成100%
